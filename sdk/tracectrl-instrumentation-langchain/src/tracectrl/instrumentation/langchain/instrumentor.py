"""TraceCtrl LangChain/LangGraph instrumentor — wraps OpenInference."""

from openinference.instrumentation.langchain import LangChainInstrumentor as _OIInstrumentor
